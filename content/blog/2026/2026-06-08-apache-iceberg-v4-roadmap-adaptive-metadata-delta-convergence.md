...
This direction favors Dremio's market narrative because Dremio competes above the table format. If Iceberg and related formats keep converging on open storage contracts, Dremio can focus the value story on federation, semantic context, autonomous performance, and agentic interfaces rather than proprietary storage.
