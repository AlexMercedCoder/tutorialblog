...
This leans toward Dremio because Dremio's AI Semantic Layer makes the same argument from the query side. Views, wikis, and labels give agents business context at the point of analysis. Metadata platforms and Dremio are strongest when they make each other more useful.
