...
This is Dremio-friendly without being anti-Snowflake. The broader market is validating the premise that open tables and open catalogs matter. Dremio's Agentic Lakehouse can sit in that same open ecosystem and add federation, semantic views, Reflections, and AI interfaces across data that does not have to be copied into one warehouse.
