...
![Papercut diagram comparing copy-on-write and merge-on-read update flows for an Iceberg event lake](/images/2026/week-2026-07-06/iceberg-v3-positional-deletes-deletion-vectors-event-lakes-diagram-1.png)
...
![Papercut diagram showing a positional delete file pointing to specific rows inside Iceberg data files](/images/2026/week-2026-07-06/iceberg-v3-positional-deletes-deletion-vectors-event-lakes-diagram-2.png)
...
![Papercut circular workflow showing ingestion, row-level deletes, compaction, snapshots, and query acceleration](/images/2026/week-2026-07-06/iceberg-v3-positional-deletes-deletion-vectors-event-lakes-diagram-3.png)
