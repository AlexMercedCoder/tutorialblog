...
The lakehouse should keep data in open formats while engines compete on planning, acceleration, and governance. Iceberg carrying richer table semantics makes the agentic lakehouse stronger: fast governed access through the semantic layer, Reflections, and automatic table optimization.
