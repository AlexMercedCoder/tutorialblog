...
An MCP server and SQL engine fit naturally as the governed execution layer for external AI clients such as Claude, Cursor, or custom agents while preserving catalog permissions and semantic definitions.
