...
Dremio's semantic layer already treats views, wikis, labels, and governed datasets as the AI context layer. Iceberg view federation makes the broader market more receptive to that argument: table formats are the base, but shared business logic is where trustworthy agentic analytics starts.
